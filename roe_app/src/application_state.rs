...
pub enum ControlFlow<ErrorType, CustomEventType> {
    Continue,
    Exit,
    PopState,
    PushState(Box<dyn ApplicationState<ErrorType, CustomEventType>>),
    PopPushState(Box<dyn ApplicationState<ErrorType, CustomEventType>>),
}
